...
nk_set_style(struct nk_context *ctx, enum theme theme)
{
    ...
    table[NK_COLOR_TEXT] = nk_la(255, 255);
    ...
    table[NK_COLOR_BUTTON_ACTIVE] = nk_rgba(255, 0, 0, 255);
    ...
    table[NK_COLOR_EDIT_CURSOR] = nk_rgba(255, 0, 0, 255);
    ...
    table[NK_COLOR_SCROLLBAR] = nk_la(32, 220);
