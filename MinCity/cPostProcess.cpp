...
void cPostProcess::create(vk::Device const& __restrict device, vk::CommandPool const& __restrict commandPool, vk::Queue const& __restrict queue, point2D_t const frameBufferSize, bool const bHDROn_) {
	...
	_temporalColorImage = new vku::TextureImageStorage2D(vk::ImageUsageFlagBits::eSampled, device,
		frameBufferSize.x, frameBufferSize.y, 1U, vk::SampleCountFlagBits::e1, (bHDROn_ ? vk::Format::eR16G16B16A16Unorm : vk::Format::eR8G8B8A8Unorm), false, true);
	
	_anamorphicFlare[0] = new vku::TextureImageStorage2D(vk::ImageUsageFlagBits::eSampled, device,
		frameBufferSize.x, frameBufferSize.y, 1U, vk::SampleCountFlagBits::e1, (bHDROn_ ? vk::Format::eR16Unorm : vk::Format::eR8Unorm));
