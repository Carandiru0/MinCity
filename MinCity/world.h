...
#define zERO 0.0f
	XMGLOBALCONST inline XMVECTORF32 const WORLD_CENTER{ 0.0f, 0.0f, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_TOP{ 0.0f, -Iso::WORLD_GRID_FHALFSIZE, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_BOTTOM{ 0.0f, Iso::WORLD_GRID_FHALFSIZE, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_LEFT{ -Iso::WORLD_GRID_FHALFSIZE, 0.0f, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_RIGHT{ Iso::WORLD_GRID_FHALFSIZE, 0.0f, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_TL{ -Iso::WORLD_GRID_FHALFSIZE, -Iso::WORLD_GRID_FHALFSIZE, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_TR{ Iso::WORLD_GRID_FHALFSIZE, -Iso::WORLD_GRID_FHALFSIZE, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_BL{ -Iso::WORLD_GRID_FHALFSIZE, Iso::WORLD_GRID_FHALFSIZE, zERO, zERO };
	XMGLOBALCONST inline XMVECTORF32 const WORLD_BR{ Iso::WORLD_GRID_FHALFSIZE, Iso::WORLD_GRID_FHALFSIZE, zERO, zERO };
#undef zERO
