...
__declspec(noinline) void global_init_tbb_floating_point_env(tbb::task_scheduler_init*& TASK_INIT)
{
	...
	//!
	TASK_INIT = new tbb::task_scheduler_init(); // automatic # of threads is best for production code;
